"""Vues du noyau : streaming sécurisé des fichiers PDF.
...
Les fichiers sont servis via FileField (stockage interchangeable) en streaming
réel : FileResponse(open(...)) lit le fichier par blocs, sans tout charger en
mémoire. Des en-têtes de cache sont posés pour les consultations répétées.
"""
...
# Cache public 1 h : les PDFs publics ne changent que via l'admin.
